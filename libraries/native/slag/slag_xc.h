...
SlagLogical sxc_cast_to_logical( SlagReal64 );
SlagLogical sxc_cast_to_logical( SlagInt64 );
SlagLogical sxc_cast_to_logical( SlagInt32 );
...
SlagObject* ArrayList_of_Object__add__Object( SXCRef context, SXCRef object );
