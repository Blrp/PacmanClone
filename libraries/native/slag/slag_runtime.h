...
#define SLAG_POP_LOGICAL() ((SlagLogical)SLAG_POP_INTEGER())
...
# define SLAG_TRY int err = setjmp(slag_cur_catch->env); if (!err)
# define SLAG_CATCH(err_name) else
# define SLAG_THROW(err) sxc_thrown_error = err; longjmp( slag_cur_catch, 1 )
